$s = Get-Content dirspider_one_liner_template.ps1 | Out-String
$j = [PSCustomObject]@{
...
("Powershell -NoLogo -NonInteractive -NoProfile -ExecutionPolicy Bypass -Encoded " + $c) | Out-File -Encoding Default one_liner.cmd
